...
Worker บันทึก snapshots แต่ไม่คำนวณอันดับ หากดึงช่องใดล้มเหลวจะเก็บ errors และทำช่องต่อไป ยังไม่มี retry loop

## งานต่อไป

กำหนด NEW, รองรับเกิน 90 ช่อง และกำหนดนโยบายคำนวณอันดับหลัง sync ก่อนเพิ่ม automation
